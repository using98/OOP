...
////Найти общую стоимость всей  техники, вывести оборудование в порядке убывания  одного из параметров.
////Найти обродудование, которое должно быть списано(политику списания определить самостоятельно)
#include <iostream>
